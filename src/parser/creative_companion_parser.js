...
export class CreativeCompanionParser {
  ...
  parse(creativeElement, creativeAttributes) {
    ...
    for (let companionResource of this.parserUtils.childrenByName(
      creativeElement,
      'Companion'
    )) {
      ...
      for (let staticElement of this.parserUtils.childrenByName(
        ...
        for (let child of this.parserUtils.childrenByName(
          companionResource,
          'AltText'
        )) {
      ...
      companionAd.companionClickThroughURLTemplate = this.parserUtils.parseNodeText(
        this.parserUtils.childByName(companionResource, 'CompanionClickThrough')
      );
