      ...
      return (
        n(e, [
          ...
          },
          {
            ...
            value: function(e, t, r) {
              for (
                var n = [], i = e < t, a = r ? (i ? t + 1 : t - 1) : t, s = e;
                i ? s < a : s > a;
                i ? s++ : s--
              )
                n.push(s);
    ...
    (e.exports = r),
      ...
      (r.prototype.listeners = function(e) {
        return this._events && this._events[e]
          ? n(this._events[e]) ? [this._events[e]] : this._events[e].slice()
          : [];
      }),
    ...
    t.VASTParser = (function(e) {
      function t() {
        ...
        return (
          ...
          (e.fetchingOptions = {}),
          (e.parserUtils = new o.ParserUtils()),
          ...
          },
          {
            ...
            value: function() {
              ...
              (this.rootURL = ''),
                ...
                (this.urlHandler = e.urlhandler || new l.URLHandler());
            }
          },
          {
            key: 'getRemainingAds',
            value: function(e) {
              ...
              return new Promise(function(r, n) {
                0 === t.remainingAds.length &&
                  n(new Error('No more ads are available for the given VAST'));
                var i = e
                ...
                (t.errorURLTemplates = []),
                  (t.parentURLs = []),
                  t
                    .resolveAds(i, { wrapperDepth: 0, originalUrl: t.rootURL })
                    .then(function(e) {
  ...
  function(e, t, r) {
    ...
    t.VASTTracker = (function(e) {
      function t(e, r, n) {
        ...
        (u._alreadyTriggeredQuartiles = {}),
        u.creative.trackingEvents)) {
          var p = u.creative.trackingEvents[c];
          u.trackingEvents[c] = p.slice(0);
        }
        return (
          u.creative instanceof a.CreativeLinear
            ? (u.setDuration(u.creative.duration),
              (u.skipDelay = u.creative.skipDelay),
              (u.linear = !0),
              (u.clickThroughURLTemplate =
                u.creative.videoClickThroughURLTemplate),
              (u.clickTrackingURLTemplates =
                u.creative.videoClickTrackingURLTemplates))
            : ((u.skipDelay = -1),
              (u.linear = !1),
              u.variation &&
                (u.variation instanceof o.NonLinearAd
                  ? ((u.clickThroughURLTemplate =
                      u.variation.nonlinearClickThroughURLTemplate),
                    (u.clickTrackingURLTemplates =
                      u.variation.nonlinearClickTrackingURLTemplates))
                  : u.variation instanceof i.CompanionAd &&
                    ((u.clickThroughURLTemplate =
                      u.variation.companionClickThroughURLTemplate),
                    (u.clickTrackingURLTemplates =
                      u.variation.companionClickTrackingURLTemplates)))),
          e &&
            u.on('start', function() {
        ...
        n(t, [
              ...
              if (
                (-1 === r ||
                  ...
                  (r > e
                    ...
                    : ((this.skippable = !0), this.emit('skip-countdown', 0))),
          ...
          },
          {
            ...
            value: function(e) {
              ...
              r ? (this.emit(e, ''), this.trackURLs(r)) : n && this.emit(e, ''),
                t &&
    ...
    t.VASTClient = (function() {
      function e(t, r, n) {
        !(function(e, t) {
          ...
          (this.vastParser = new o.VASTParser()),
          (this.util = new s.Util()),
          ...
          },
          {
            ...
            value: function(e) {
              var t = this,
                ...
                i = Date.now();
              return (
                (r = n(this.defaultOptions, r)).hasOwnProperty('resolveAll') ||
                  (r.resolveAll = !1),
                ...
                new Promise(function(n, a) {
                  ...
                  var s = i - t.lastSuccessfulAd;
                  s < 0
                    ? (t.lastSuccessfulAd = 0)
                    : s < t.cappingMinimumTimeInterval &&
                      a(
                        new Error(
                          'VAST call canceled – (' +
        ...
        n(e, [
          {
            ...
            value: function(e, t, r) {
              if (
                (r || ('function' == typeof t && (r = t), (t = {})), t.response)
              ) {
                var n = t.response;
                      ...
                      r.parserUtils
                        ...
                        .forEach(function(e) {
                          (t.type = e.getAttribute('creativeType') || 0),
                            (t.iframeResource = r.parserUtils.parseNodeText(e));
                        }),
                      r.parserUtils
                        .childrenByName(e, 'StaticResource')
                        .forEach(function(e) {
                          (t.type = e.getAttribute('creativeType') || 0),
                            (t.staticResource = r.parserUtils.parseNodeText(e));
                        });
        ...
        n(e, [
          {
            ...
            value: function(e, t) {
              var r = this,
                n = void 0,
                o = new i.CreativeLinear(t);
              o.duration = this.parserUtils.parseDuration(
                this.parserUtils.parseNodeText(
                  this.parserUtils.childByName(e, 'Duration')
                )
              );
              var l = e.getAttribute('skipoffset');
              if (null == l) o.skipDelay = null;
              else if ('%' === l.charAt(l.length - 1) && -1 !== o.duration) {
                var u = parseInt(l, 10);
                o.skipDelay = o.duration * (u / 100);
              } else o.skipDelay = this.parserUtils.parseDuration(l);
              var c = this.parserUtils.childByName(e, 'VideoClicks');
              c &&
                ((o.videoClickThroughURLTemplate = this.parserUtils.parseNodeText(
                  this.parserUtils.childByName(c, 'ClickThrough')
                )),
                this.parserUtils
                  .childrenByName(c, 'ClickTracking')
                  .forEach(function(e) {
                    o.videoClickTrackingURLTemplates.push(
                      r.parserUtils.parseNodeText(e)
                    );
                  }),
                this.parserUtils
                  ...
                  .forEach(function(e) {
                    o.videoCustomClickURLTemplates.push(
                      r.parserUtils.parseNodeText(e)
                    );
                  }));
              var p = this.parserUtils.childByName(e, 'AdParameters');
              p && (o.adParameters = this.parserUtils.parseNodeText(p)),
                this.parserUtils
                  .childrenByName(e, 'TrackingEvents')
                  .forEach(function(e) {
                    r.parserUtils
                      ...
                      .forEach(function(e) {
                        ...
                        if (t && i) {
                          ...
                          null == o.trackingEvents[t] &&
                            (o.trackingEvents[t] = []),
                            o.trackingEvents[t].push(i);
                        }
                      });
                  }),
                this.parserUtils
                      ...
                      r.parserUtils
                        ...
                        .forEach(function(n) {
                          (t.type = n.getAttribute('creativeType') || 0),
                            ...
                            (t.staticResource = r.parserUtils.parseNodeText(n));
                        }),
                      r.parserUtils
                        .childrenByName(e, 'TrackingEvents')
                        .forEach(function(e) {
    ...
    t.AdParser = (function() {
      function e() {
        !(function(e, t) {
          ...
          (this.creativeCompanionParser = new o.CreativeCompanionParser()),
          (this.creativeNonLinearParser = new u.CreativeNonLinearParser()),
          (this.creativeLinearParser = new l.CreativeLinearParser()),
          ...
          },
          {
            ...
            value: function(e) {
              ...
              r)) {
                ...
                switch (s.nodeName) {
                  case 'Error':
                    n.errorURLTemplates.push(this.parserUtils.parseNodeText(s));
                    break;
                  case 'Impression':
                    n.impressionURLTemplates.push(
                      this.parserUtils.parseNodeText(s)
                    );
                    break;
                  case 'Creatives':
                    this.parserUtils
                      .childrenByName(s, 'Creative')
                      .forEach(function(e) {
                        var r = {
                        ...
                        for (var i in e.childNodes) {
                          ...
                          switch (a.nodeName) {
                            case 'Linear':
                              var s = t.creativeLinearParser.parse(a, r);
                              s && n.creatives.push(s);
                              break;
                            case 'NonLinearAds':
                              var o = t.creativeNonLinearParser.parse(a, r);
                              o && n.creatives.push(o);
                              break;
                            case 'CompanionAds':
                              var l = t.creativeCompanionParser.parse(a, r);
                              l && n.creatives.push(l);
                          }
                        }
                      });
                    break;
                  case 'Extensions':
                    this.parseExtensions(
                      n.extensions,
                      this.parserUtils.childrenByName(s, 'Extension')
                    );
                    break;
                  case 'AdSystem':
                    n.system = {
                      value: this.parserUtils.parseNodeText(s),
                      version: s.getAttribute('version') || null
                    };
                    break;
                  case 'AdTitle':
                    n.title = this.parserUtils.parseNodeText(s);
                    break;
                  case 'Description':
                    n.description = this.parserUtils.parseNodeText(s);
                    break;
                  case 'Advertiser':
                    n.advertiser = this.parserUtils.parseNodeText(s);
                    break;
                  case 'Pricing':
                    n.pricing = {
                      value: this.parserUtils.parseNodeText(s),
                    ...
                    break;
                  case 'Survey':
                    n.survey = this.parserUtils.parseNodeText(s);
                }
              }
              return n;
            }
              ...
              t.forEach(function(t) {
                ...
                if (t.attributes)
                  for (var l in i) {
                    ...
                    u.nodeName &&
                      u.nodeValue &&
                      (n.attributes[u.nodeName] = u.nodeValue);
                  }
                for (var c in o) {
                  var p = o[c],
                    h = r.parserUtils.parseNodeText(p);
                  if ('#comment' !== p.nodeName && '' !== h) {
                    var f = new s.AdExtensionChild();
                    if (((f.name = p.nodeName), (f.value = h), p.attributes)) {
                      var d = p.attributes;
                      for (var v in d) {
                        var m = d[v];
                        f.attributes[m.nodeName] = m.nodeValue;
                      }
                    }
                    n.children.push(f);
                  }
